...
namespace Tests
{
	...
	public class FolderObjectTextFixture : BaseTest
	{
		...
		public void Test_CreateOrTruncateSubFolder_Should_Create_New_SubFolder([Values(true, false)] bool truncate)
		{
			...
			Assert.That(subFolderPath, Is.EqualTo(subFolder.FullName));
		}
		...
		//    // Assert
		//    Assert.That(Directory.Exists(subFolder.FullName), Is.True);
		//    Assert.That(subFolderPath, Is.EqualTo(subFolder.FullName));
		//}
		...
		//    var absoluteFolder = new FolderObject(BaseFolder.FullName + subFolderName);
		...
		//    var relativeFolder = new FolderObject(BaseFolderRelative.FullName + subFolderName);
		...
		//    var relativeFolder = new FolderObject(BaseFolder.FullName + subFolderName);
		...
		//    var absoluteFolder = new FolderObject(BaseFolderRelative.FullName + subFolderName);
		...
		//{
		//    var newFile = $"{BaseFolder.FullName}DisposeTest";
		...
		//    var newFolder = $"{RelativeTestFolder.FullName}MOVE";
		...
		//    var newFile = $"{RelativeTestFolder.FullName}COPY";
