...
namespace DotNetHelper.IO.Tests
{
    ...
    public class WriteTestFixture : BaseTest
    {
        ...
        [Author("Joseph McNeal Jr", "josephmcnealjr@gmail.com")]
        [Test]
        public void Test_Write_To_File_IncrementFileNameIfExistWithNumberExtension()
        {
            var testFile = new FileObject(RandomTestFileWithExtension.FileNameOnly + "1.1");
            ...
            // Assert.That(newFileWithNameIncruemented.Equals(testFile.FileNameOnly.Replace("1.", "2.") + ".1"));
            // Assert.That(newFileWithNameIncruemented2.Equals(testFile.FileNameOnly.Replace("2.", "3.") + ".1"));
        }
        ...
        [Author("Joseph McNeal Jr", "josephmcnealjr@gmail.com")]
        [Test]
        public void Test_Write_To_File_IncrementFileExtensionIfExist_WithNumberExtension()
        {
            var testFile = new FileObject(RandomTestFileNoExtension.FullName + "1.1");
            ...
            // Assert.That(newFileWithNameIncruemented.Equals(testFile.FilePathOnly + testFile.FileNameOnly + ".2"),$"wrong name {newFileWithNameIncruemented} vs {testFile.FullName}");
            // Assert.That(newFileWithNameIncruemented2.Equals(testFile.FilePathOnly + testFile.FileNameOnly + ".3"),$"wrong name {newFileWithNameIncruemented2} vs {testFile.FullName}");
        }
