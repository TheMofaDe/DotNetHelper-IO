    ...
    .Does<BuildParameters>((context,parameters) =>
{
    ...
    foreach(var project in parameters.SolutionProjects){  
        ...
        if(!project.AssemblyName.Contains("Tests")) // does not support single target .net 5 yet https://github.com/cake-contrib/Cake.Incubator/blob/3858732caa686c9edf16111459869cde2e2694a6/src/Cake.Incubator/Project/ProjectParserExtensions.cs
        continue;
